            ...
            <form action="{{ route('visites.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <!-- Normally this is a select, keeping it as select for functionality but styled like the mockup -->
                        <select name="praticien_id" id="praticien_id" required class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm text-gray-900 appearance-none bg-white">
                            <option value="" disabled selected>Sélectionnez un professionnel</option>
                            @foreach($praticiens ?? [] as $praticien)
                                <option value="{{ $praticien->id }}">{{ $praticien->nom_complet }}</option>
                            @endforeach
                            <!-- Dummy option for UI if no data -->
                            <option value="1">Dr. Martin Pierre</option>
                        </select>
                    </div>
                </div>

                <!-- Spécialité (Auto-filled ideally, here just a text input for mockup) -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" readonly value="Cardiologue" class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-500 sm:text-sm" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date_visite" id="date_visite" required class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="heure" id="heure" class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" readonly value="Hôpital Fann" class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-500 sm:text-sm" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea id="notes" name="notes" rows="4" placeholder="Objectifs de la visite, produits à présenter..." class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm"></textarea>
                    </div>
                </div>
